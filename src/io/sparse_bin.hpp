...
#undef ARGUMENTS
 ...
 const void* GetColWiseData(int8_t* bit_type, bool* is_sparse, std::vector<BinIterator*>* bin_iterator, const int num_threads) const override;

 const void* GetColWiseData(int8_t* bit_type, bool* is_sparse, BinIterator** bin_iterator) const override;
